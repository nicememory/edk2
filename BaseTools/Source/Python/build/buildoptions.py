...
class MyOptionParser():
    ...
    def GetOption(self):
        ...
        Parser.add_option("-a", "--arch", action="append", dest="TargetArch",
            help="ARCHS is one of list: IA32, X64, ARM, AARCH64, RISCV64, EBC or Mips64, which overrides target.txt's TARGET_ARCH definition. To specify more archs, please repeat this option.")
